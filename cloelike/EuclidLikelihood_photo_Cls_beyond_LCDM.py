...
class PhotoLikelihoodProtocol(Protocol):
    ...
    Attributes:
        ...
        LinPerturbationsBase (Perturbations): Linear perturbations instance.
        gravity_model (string): Gravity model to be used (e.g. dgp,fr,ide)
    ...
    LinPerturbations: Perturbations
    NonLinPerturbations: Perturbations
    LinPerturbationsBase: Perturbations
    gravity_model: str
    derived: dict
    mode: str
...
class PhotoLikelihoodBase:
    ...
    LinPerturbationsBase: object
        Linear perturbations instance.
    gravity_model: string
        string giving gravity model to be used (e.g. dgp,fr,ide)
    mode : str, optional
...
class WLMixin:
    ...
    def get_theory_vector_full(self, parameters):
        ...
        # Override w0 and wa if necessary
        if is_ide:
            background_params["w0"] = -1.0
            background_params["wa"] = 0.0
